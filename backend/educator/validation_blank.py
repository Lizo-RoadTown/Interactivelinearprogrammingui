"""
validation_blank.py — BEGINNER B (clean starter copy)
=====================================================

This is a pristine copy of the starter skeleton for `validation.py`.

If a student breaks their working file during the demo and you need to reset
them quickly, copy the contents of this file over `validation.py`:

    cp backend/educator/validation_blank.py backend/educator/validation.py

The actual file students edit is `validation.py`. Don't edit this one — it's
the safety net.
